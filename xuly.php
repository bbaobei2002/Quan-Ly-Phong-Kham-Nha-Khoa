<?php
    ...
    $email      = addslashes($_POST['usergmail']);
    
          
    //Kiểm tra người dùng đã nhập liệu đầy đủ chưa
    if (!$username || !$userpassword || !$usergmail )
    {
    ...
    //Kiểm tra tên đăng nhập này đã có người dùng chưa
     if (mysql_num_rows(mysql_query("SELECT username FROM member WHERE username='$username'"))  ){
    ...
    if ($addmember)
        echo "Quá trình đăng ký thành công. <a href='homepage.php'</a>";
    else
