...
$sql = "select * from ketoa where idkt = $id";
...
<form name="form3" method="post" action="capnhat4.php" style="margin-left: 330px">
  <table class="w3-center w3-text-black" style= "background-color: white; width: 60%; height: 300px;" border="3">
    ...
    <td><input type="sttpk" name="sttpk" value="<?php echo $row['sttpk']; ?>" readonly size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Mã toa thuốc:</strong></td>
    <td><input type="idkt" name="idkt" value="<?php echo $row['idkt']; ?>" readonly size="40"></td>
    </tr>
    ...
    <td><input type="chuandoan" name="chuandoan" value="<?php echo $row['chuandoan']; ?>" size="40"></td>
    </tr>

     <tr style="background-color: skyblue;">
    <td><strong>Thuốc điều trị:</strong></td>
    <td><input type="thuocdieutri" name="thuocdieutri" value="<?php echo $row['thuocdieutri']; ?>" size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Số lượng:</strong></td>
    <td><input type="soluong" name="soluong" value="<?php echo $row['soluong']; ?>" size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Liều dùng:</strong></td>
    <td><input type="lieudung" name="lieudung" value="<?php echo $row['lieudung']; ?>" size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Ngày tái khám:</strong></td>
    <td><input type="ngaytaikham" name="ngaytaikham" value="<?php echo $row['ngaytaikham']; ?>" size="40"></td>
    </tr>
