...
<table class="w3-center w3-text-black" style= "background-color: white; margin-left: 100px; width: 80%; height: 300px;" border="3">
  ...
  ?>
    <tr>
      <td><?php echo $row['sttpk']; ?></td>
      <td><?php echo $row['idkt']; ?></td>
      <td><?php echo $row['idbn']; ?></td>
      <td><?php echo $row['chuandoan']; ?></td>
      <td><?php echo $row['thuocdieutri']; ?></td>
      <td><?php echo $row['soluong']; ?></td>
      <td><?php echo $row['lieudung']; ?></td>
      <td><?php echo $row['ngaytaikham']; ?></td>
  
      <td><strong><a style="color: darkblue;" href="upkt.php?id=<?php echo $row['idkt']; ?>">Cập nhật</a></strong></td>
      <td><strong><a style="color: darkred;" href="delete.php?id=<?php echo $row['idkt']; ?>"onClick="return confirm('Bạn có thật sự muốn xóa?');">Xóa</a></strong></td>
    </tr>
