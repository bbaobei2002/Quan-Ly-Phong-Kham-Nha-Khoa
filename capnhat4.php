...
$sql = "update phieukham sttpk='$sttpk', idbn='$idbn', chuandoan='$chuandoan', thuocdieutri='$thuocdieutri', soluong='$soluong', lieudung='$lieudung', ngaytaikham='$ngaytaikham' where idkt = $idkt";
