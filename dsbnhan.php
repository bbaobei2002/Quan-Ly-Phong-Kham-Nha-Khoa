...
<table class="w3-center w3-text-black" style= "background-color: white; margin-left: 100px; width: 80%; height: 300px;" border="3">
  ...
  ?>
    <tr>
      ...
      <td><strong><a style="color: orange;" href="pkham.php?id=<?php echo $row['id']; ?>">Tạo phiếu khám</a></strong></td>
      <td><strong><a style="color: darkblue;" href="updbn.php?id=<?php echo $row['id']; ?>">Cập nhật</a></strong></td>
      <td><strong><a style="color: darkred;" href="delete.php?id=<?php echo $row['id']; ?>"onClick="return confirm('Bạn có thật sự muốn xóa?');">Xóa</a></strong></td>
    </tr>
