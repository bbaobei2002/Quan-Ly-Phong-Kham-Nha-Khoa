...
<div class="w3-container w3-padding-large w3-white">
    <h4 class="w3-center" style="font-size: 25pt; margin-bottom:-45px;" id="ketoa"><b>Kê toa</b></h4>
<form action="connectkt.php" method="post">
<b><label>STT: </label></b> <input type="sttpk" size="5" name="sttpk">
<b><label>Mã toa thuốc: </label></b> <input type="idkt" size="5" name="idkt">
<b><label>Mã bệnh nhân: </label></b> <input type="idbn" size="5" name="idbn">
    ...
    <!-- <form action="/action_page.php" target="_blank"> -->
      <div class="w3-section">
        ...
        <input type="chuandoan" style="block-size: 40px;" class="w3-input w3-border" required="" name="chuandoan">
      </div>
      <div class="w3-section">
        <label><b>Thuốc điều trị:</b></label>
        <input type="thuocdieutri" style="block-size: 40px;" class="w3-input w3-border"  required="" name="thuocdieutri">
      </div>

      <div class="w3-section">
        <label><b>Số lượng:</b></label>
        <input type="soluong" style="block-size: 40px;" class="w3-input w3-border"  required="" name="soluong">
      </div>

      <div class="w3-section">
        <label><b>Liều dùng:</b></label>
        <input type="lieudung" style="block-size: 40px;" class="w3-input w3-border"  required="" name="lieudung">
      </div>

      <div class="w3-section">
        <label><b>Ngày tái khám:</b></label>
        <input type="ngaytaikham" style="block-size: 40px;" class="w3-input w3-border"  required="" name="ngaytaikham">
      </div>
      
      <div class="clearfix"></div>
      <button type="submit" name="ketoa" class="w3-button w3-black w3-margin-bottom"><i style="color: lightblue;" class="fa fa-paper-plane w3-margin-right"></i>Kê toa</button>
    </form>
  </div></p>
...
$sql = "select * from phieukham where stt = $id";
...
<form name="form2" method="post" action="capnhat3.php">
  <table class="w3-center w3-text-black" style= "background-color: white; width: 60%; height: 300px;" border="3">
    ...
    <td><input type="stt" name="stt" value="<?php echo $row['stt']; ?>" readonly size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Mã bệnh nhân:</strong></td>
    <td><input type="idbn" name="idbn" value="<?php echo $row['idbn']; ?>" readonly size="40"></td>
    </tr>

    <tr style="background-color: skyblue;">
    <td><strong>Ngày khám:</strong></td>
    <td><input type="ngaykham" name="ngaykham" value="<?php echo $row['ngaykham']; ?>" size="40"></td>
    </tr>

     <tr style="background-color: skyblue;">
    <td><strong>Triệu chứng:</strong></td>
    <td><input type="trieuchung" name="trieuchung" value="<?php echo $row['trieuchung']; ?>" size="40"></td>
    </tr>
  </table>
</form>
