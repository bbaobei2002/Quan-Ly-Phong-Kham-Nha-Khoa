 ...
 <!-- form -->
  <div class="w3-container w3-padding-large w3-white">
    ...
    <!-- <form action="/action_page.php" target="_blank"> -->
      ...
      <button type="submit" name="thebn" class="w3-button w3-black w3-margin-bottom"><i style="color: lightblue;" class="fa fa-paper-plane w3-margin-right"></i>Tạo thẻ bệnh nhân</button>
    </form>
  </div>
